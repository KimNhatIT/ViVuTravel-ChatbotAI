            ...
            <div className="w-[90%] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <Link to="/" className="flex items-center gap-2">
                        <img src={logo} alt="vivutravel logo" className="h-10 w-auto sm:h-12 lg:h-14" />
                        <span className="text-3xl font-black tracking-tight">
                            <span className="text-blue-600">Vi</span>
                            <span className="text-cyan-500">Vu</span>
                            <span className="text-gray-800 ml-1 text-2xl font-semibold">Travel</span>
                        </span>
                    </Link>
